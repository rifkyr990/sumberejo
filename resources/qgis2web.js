...
map.getView().fit([12226500.062055, -804944.780942, 12227292.632816, -804441.159830], map.getSize());
    ...
    for (var i = 0; i < currentFeatureKeys.length; i++) {
        if (currentFeatureKeys[i] != 'geometry') {
            ...
            if (layer.get('fieldImages')[currentFeatureKeys[i]] != "ExternalResource") {
                ...
                popupField += (currentFeature.get(currentFeatureKeys[i]) != null ? '<img style="width: 100px;" src="' + currentFeature.get(currentFeatureKeys[i]) + '" /></td>' : '');
            }
